...
function App() {
  ...
  async function getAllData() {
    try {
      ...
      const res = await fetch(`${baseURL}/history-process-instance`);
      //alert('res: '+ res.json());
      if (!res.ok) {
  ...
  return (
    <div id="app" className="container my-3">
      ...
      <div className="card mt-3">
        <div className="card-header">GET - From Camunda</div>
        <div className="card-body">
          <div className="input-group input-group-sm">
            <button className="btn btn-sm btn-primary" onClick={getAllData}>Get Process History instance</button>
      ...
      <div className="card mt-3">
        <div className="card-header">POST To Camunda</div>
        <div className="card-body">
      ...
      <div className="card mt-3">
        <div className="card-header">PUT To Camunda</div>
        <div className="card-body">
          <div className="form-group">
      ...
      <div className="card mt-3">
        <div className="card-header">DELETE From Camunda</div>
        <div className="card-body">
          <div className="input-group input-group-sm">
